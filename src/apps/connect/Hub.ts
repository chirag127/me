...
export default async function Hub(c: HTMLElement): Promise<void> {
  c.innerHTML = `<div class="page animate-fade-in"><header class="page-header"><h1 class="page-title">Connect</h1><p class="page-subtitle">Find me across the web</p></header><div class="bento-grid"><div class="bento-item"><h3>🐘 Mastodon</h3><p id="mastodon-stats">Loading...</p><a href="https://mastodon.social/@chirag127" target="_blank" class="btn btn-ghost">Follow →</a></div><div class="bento-item"><h3>🦋 Bluesky</h3><a href="https://bsky.app/profile/chirag127.bsky.social" target="_blank" class="btn btn-ghost">Follow →</a></div><div class="bento-item"><h3>📝 Dev.to</h3><p id="devto-stats">Loading...</p><a href="https://dev.to/chirag127" target="_blank" class="btn btn-ghost">Read →</a></div><div class="bento-item span-2"><h3>✉️ Contact</h3><p>Want to get in touch?</p><a href="#/connect/mail" class="btn btn-primary">Send Message →</a></div></div></div>`;
  try {
