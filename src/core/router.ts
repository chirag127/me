...
export const routes: Route[] = [
  ...
  { path: '/me/journal', name: 'Write', icon: '✍️', component: () => import('../apps/me/Journal'), drive: 'ME', breadcrumb: ['Me', 'Journal', 'Write'], category: 'Journal' },
  { path: '/me/journal-feed', name: 'Feed', icon: '📰', component: () => import('../apps/me/JournalFeed'), drive: 'ME', breadcrumb: ['Me', 'Journal', 'Feed'], category: 'Journal' },
  { path: '/me/journal-charts', name: 'Analytics', icon: '📊', component: () => import('../apps/me/JournalCharts'), drive: 'ME', breadcrumb: ['Me', 'Journal', 'Analytics'], category: 'Journal' },
