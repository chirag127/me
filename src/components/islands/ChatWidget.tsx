...
import { saveChatMessage, subscribeToChatMessages, getOnAuthStateChanged, getAuthInstance, type User, type ChatMessage } from '../../lib/firebase';
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            ...
            {messages.map((msg) => (
              <div key={msg.id} className="flex flex-col gap-1">
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-medium text-indigo-400">{msg.userName}</span>
                  <span className="text-[10px] text-white/20">{msg.pageContext}</span>
                </div>
