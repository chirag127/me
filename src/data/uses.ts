...
export const usesData: UseCategory[] = [
  {
    ...
    items: [
      ...
      { name: "Windows Terminal", description: "Terminal with WSL2 for Linux development" },
      { name: "Git", description: "Version control with conventional commits" },
      { name: "Docker Desktop", description: "Container management and development" },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "Python", description: "Backend, AI/ML, automation, and scripting" },
      { name: "Astro", description: "Static site generation and content sites" },
  ...
  },
  {
    ...
    items: [
      { name: "Cloudflare Pages", description: "Static site hosting with edge CDN" },
