...
export const IDENTITY: Identity = {
    ...
    firstName: "Chirag",
    lastName: "Singhal",
    bio: "Software Engineer with extensive experience across the full SDLC, specializing in scalable backend architectures, full-stack development, AI-driven automation, and cloud-native deployments.",
    tagline: "Full Stack, Backend & Distributed Systems Specialist",
