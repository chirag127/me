...
async function getTokens() {
  ...
  console.log(
    `   https://trakt.tv/oauth/authorize?response_type=code&client_id=${clientId}&redirect_uri=urn%3Aietf%3Awg%3Aoauth%3A2.0%3Aoob&code_challenge=${codeChallenge}&code_challenge_method=S256`,
  );
